...
public interface CheckRoomMapper {
    ...
    @Select("select room_max_person from room_list where room_name = 'A'")
    public int getMaxPersonRoomA();

    @Select("select room_min_person from room_list where room_name = 'A'")
    ...
    @Select("select room_max_person from room_list where room_name = 'B'")
    public int getMaxPersonRoomB();

    @Select("select room_min_person from room_list where room_name = 'B'")
